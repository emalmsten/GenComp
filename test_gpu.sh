...
#SBATCH --mem=2048          # Request memory (MB) per node. Default is 1024MB (1GB). For multiple tasks, specify --mem-per-cpu instead
...
module load cuda/12.1 cudnn/12-8.9.1.23
